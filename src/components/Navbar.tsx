                ...
                <div className="flex items-center justify-between h-16 md:h-20">
                    <div className="flex items-center">
                        <Link href="/" className="flex items-center space-x-2 md:space-x-3 group relative">
                            <Terminal className="w-6 h-6 md:w-8 md:h-8 text-cyber-green group-hover:drop-shadow-[0_0_8px_rgba(57,255,20,0.8)] transition-all" />
                            <span className="font-mono text-lg md:text-xl lg:text-2xl font-bold tracking-tighter text-white group-hover:text-cyber-green transition-colors">
